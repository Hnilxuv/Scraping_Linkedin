...
# 1: Auto login to Linkedin

# 1.1: Auto open Chrome and Access Linkedin login site
...
# 1.2: Auto Import username and password
credential = open('my_username_password.txt')
line = credential.readlines()
username = line[0]
password = line[1]
print('- Finish importing the login username and password ')
sleep(2)

# 1.3: Key in login username and password
...
# 3.1: Write a function to extract the URLs of one page
def GetURL():
